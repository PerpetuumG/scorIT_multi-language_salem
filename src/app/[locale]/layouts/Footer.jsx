...
const Footer = () => {
  ...
  return (
    <footer
      className={'md:py-16 py-8 bg-black border-t shadow-inner shadow-white border-white mt-10'}
    >
      <Container>
        <div className={'md:flex text-white justify-between align-top gap-10'}>
          ...
          <div className={'md:w-1/4 mb-6 md:mb-1'}>
            ...
            <ul className={'mt-5'}>
              <li>
                <Link className={'hover:underline duration-100'} href={'/privacy-police'}>
                  {t('privacyPolicy')}
                </Link>
              </li>
              <li>
          ...
          <div className={'md:w-1/4 mb-6 md:mb-1'}>
            ...
            <div className={'mt-5 flex gap-3'}>
              <Link href={'#'}>
                <FaFacebook
                  className={
                    'p-2 border border-white hover:bg-white hover:text-black duration-100 text-4xl rounded-sm'
                  }
                />
              </Link>
              <Link href={'#'}>
